      ...
      <button
        onClick={(e) => {
          ...
          window.location.href =
            "https://accounts.spotify.com/authorize?client_id=b36ac668448643798290591e95096ff7&response_type=code&scope=user-library-read user-library-modify user-top-read playlist-modify-private playlist-read-collaborative playlist-read-private playlist-modify-public&redirect_uri=https://verseatility.co";
        }}
      >
        Create Playlist
      </button>
